{
  ...
  '#':: d.pkg(name='securityGroupPolicy', url='', help='"Custom Resource Definition for applying security groups to pods"'),
  ...
  '#new':: d.fn(help='new returns an instance of SecurityGroupPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'vpcresources.k8s.aws/v1beta1',
    kind: 'SecurityGroupPolicy',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"SecurityGroupPolicySpec defines the desired state of SecurityGroupPolicy"'),
  spec: {
    ...
    '#securityGroups':: d.obj(help='"GroupIds contains the list of security groups that will be applied to the network interface of the pod matching the criteria."'),
    securityGroups: {
      '#withGroupIds':: d.fn(help='"Groups is the list of EC2 Security Groups Ids that need to be applied to the ENI of a Pod."', args=[d.arg(name='groupIds', type=d.T.array)]),
      withGroupIds(groupIds): { spec+: { securityGroups+: { groupIds: if std.isArray(v=groupIds) then groupIds else [groupIds] } } },
      '#withGroupIdsMixin':: d.fn(help='"Groups is the list of EC2 Security Groups Ids that need to be applied to the ENI of a Pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='groupIds', type=d.T.array)]),
      withGroupIdsMixin(groupIds): { spec+: { securityGroups+: { groupIds+: if std.isArray(v=groupIds) then groupIds else [groupIds] } } },
    },
    '#serviceAccountSelector':: d.obj(help='"A label selector is a label query over a set of resources. The result of matchLabels and matchExpressions are ANDed. An empty label selector matches all objects. A null label selector matches no objects."'),
    serviceAccountSelector: {
      ...
      '#withMatchExpressions':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."', args=[d.arg(name='matchExpressions', type=d.T.array)]),
      withMatchExpressions(matchExpressions): { spec+: { serviceAccountSelector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } },
      '#withMatchExpressionsMixin':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
      withMatchExpressionsMixin(matchExpressions): { spec+: { serviceAccountSelector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } },
      '#withMatchLabels':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."', args=[d.arg(name='matchLabels', type=d.T.object)]),
      withMatchLabels(matchLabels): { spec+: { serviceAccountSelector+: { matchLabels: matchLabels } } },
      '#withMatchLabelsMixin':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
      withMatchLabelsMixin(matchLabels): { spec+: { serviceAccountSelector+: { matchLabels+: matchLabels } } },
    },
  },
  '#mixin': 'ignore',
  mixin: self,
